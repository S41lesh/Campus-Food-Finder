...
export default function AdminScreen() {
  ...
  <TouchableOpacity 
              ...
              }} className="p-4 rounded-full mb-10">
                <PlusIcon size="40" onPress={()=>navigation.navigate('AddFood',{ data: activeCategory.id })} strokeWidth={2} color={themeColors.white} />
              </TouchableOpacity>
</View>
